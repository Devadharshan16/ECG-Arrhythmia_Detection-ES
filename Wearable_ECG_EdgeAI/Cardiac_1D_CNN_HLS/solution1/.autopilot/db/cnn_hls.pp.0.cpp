...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/vishal/2026.1/Vitis/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 105 "/home/vishal/2026.1/Vitis/common/technology/autopilot/etc/autopilot_ssdm_op.h"
extern "C" {
...
# 2 "<built-in>" 2
# 1 "cnn_hls.cpp" 2
# 1 "/home/vishal/2026.1/lnx64/tools/clang-16/lib/clang/16/include/stdint.h" 1 3
# 52 "/home/vishal/2026.1/lnx64/tools/clang-16/lib/clang/16/include/stdint.h" 3
...
# 53 "/home/vishal/2026.1/lnx64/tools/clang-16/lib/clang/16/include/stdint.h" 2 3
# 2 "cnn_hls.cpp" 2
# 1 "./weights.h" 1
# 24 "./weights.h"
...
#line 21 "/home/vishal/vishal_dev/EB_caps/ECG-Arrhythmia_Detection-ES/Wearable_ECG_EdgeAI/build_hls.tcl"
...
#pragma HLS ARRAY_PARTITION variable=buffer_c2 complete dim=1
    ...
    VITIS_LOOP_33_1: for (int oc = 0; oc < CONV1_OUT_CH; ++oc) {
#pragma HLS PIPELINE II=1
        VITIS_LOOP_35_2: for (int out_idx = 0; out_idx < 45; ++out_idx) {
#pragma HLS UNROLL
            int32_t acc = conv1_bias[oc];

            VITIS_LOOP_39_3: for (int k = 0; k < CONV1_KERNEL; ++k) {
#pragma HLS UNROLL
    ...
    VITIS_LOOP_59_4: for (int oc = 0; oc < CONV2_OUT_CH; ++oc) {
#pragma HLS PIPELINE II=1
        VITIS_LOOP_61_5: for (int out_idx = 0; out_idx < 23; ++out_idx) {
#pragma HLS UNROLL
            int32_t acc = conv2_bias[oc];

            VITIS_LOOP_65_6: for (int in_ch = 0; in_ch < CONV2_IN_CH; ++in_ch) {
#pragma HLS UNROLL
                VITIS_LOOP_67_7: for (int k = 0; k < CONV2_KERNEL; ++k) {
#pragma HLS UNROLL
    ...
    VITIS_LOOP_88_8: for (int oc = 0; oc < CONV3_OUT_CH; ++oc) {
#pragma HLS PIPELINE II=1
        VITIS_LOOP_90_9: for (int out_idx = 0; out_idx < 12; ++out_idx) {
#pragma HLS UNROLL
            int32_t acc = conv3_bias[oc];

            VITIS_LOOP_94_10: for (int in_ch = 0; in_ch < CONV3_IN_CH; ++in_ch) {
#pragma HLS UNROLL
                VITIS_LOOP_96_11: for (int k = 0; k < CONV3_KERNEL; ++k) {
#pragma HLS UNROLL
    ...
    VITIS_LOOP_116_12: for (int i = 0; i < 16; ++i) {
        VITIS_LOOP_117_13: for (int j = 0; j < 12; ++j) {
#pragma HLS PIPELINE II=1
    ...
    VITIS_LOOP_126_14: for (int out_class = 0; out_class < FC_OUT; ++out_class) {
#pragma HLS PIPELINE II=1
        int32_t acc = fc_bias[out_class];

        VITIS_LOOP_130_15: for (int idx = 0; idx < FC_IN; ++idx) {
#pragma HLS UNROLL
