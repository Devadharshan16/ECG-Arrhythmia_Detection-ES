...
// wrapc file define:
#define AUTOTB_TVIN_input_ecg "../tv/cdatafile/c.tiny_ecg_inference.autotvin_input_ecg.dat"
#define AUTOTB_TVOUT_input_ecg "../tv/cdatafile/c.tiny_ecg_inference.autotvout_input_ecg.dat"
#define AUTOTB_TVIN_output_logits "../tv/cdatafile/c.tiny_ecg_inference.autotvin_output_logits.dat"
#define AUTOTB_TVOUT_output_logits "../tv/cdatafile/c.tiny_ecg_inference.autotvout_output_logits.dat"
#define AUTOTB_TVIN_DATA_IN "../tv/cdatafile/c.tiny_ecg_inference.autotvin_DATA_IN.dat"
#define AUTOTB_TVOUT_DATA_IN "../tv/cdatafile/c.tiny_ecg_inference.autotvout_DATA_IN.dat"
#define AUTOTB_TVIN_DATA_OUT "../tv/cdatafile/c.tiny_ecg_inference.autotvin_DATA_OUT.dat"
#define AUTOTB_TVOUT_DATA_OUT "../tv/cdatafile/c.tiny_ecg_inference.autotvout_DATA_OUT.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_DATA_IN "../tv/rtldatafile/rtl.tiny_ecg_inference.autotvout_DATA_IN.dat"
#define AUTOTB_TVOUT_PC_DATA_OUT "../tv/rtldatafile/rtl.tiny_ecg_inference.autotvout_DATA_OUT.dat"
...
extern "C"
void tiny_ecg_inference_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_tiny_ecg_inference_hw(void* __xlx_apatb_param_input_ecg, void* __xlx_apatb_param_output_logits)
{
  static hls::sim::Byte<4> __xlx_offset_byte_param_input_ecg;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_input_ecg),
#endif
  };
  port0.param = &__xlx_offset_byte_param_input_ecg;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_DATA_IN),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_DATA_IN),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_DATA_OUT),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_DATA_OUT),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_DATA_OUT),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_DATA_OUT),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_DATA_OUT),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_DATA_OUT),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  ...
  try {
    ...
    tiny_ecg_inference_hw_stub_wrapper(__xlx_apatb_param_input_ecg, __xlx_apatb_param_output_logits);
