set moduleName tiny_ecg_inference_Pipeline_6
set isTopModule 0
...
set cdfgNum 11
set C_modelName {tiny_ecg_inference_Pipeline_6}
...
set portList { 
	...
	{ local_out_address0 sc_out sc_lv 3 signal 0 } 
	{ local_out_ce0 sc_out sc_logic 1 signal 0 } 
	{ local_out_we0 sc_out sc_logic 1 signal 0 } 
	{ local_out_d0 sc_out sc_lv 8 signal 0 } 
}
set NewPortList {[ 
