set moduleName tiny_ecg_inference_Pipeline_VITIS_LOOP_181_17
set isTopModule 0
...
set cdfgNum 11
set C_modelName {tiny_ecg_inference_Pipeline_VITIS_LOOP_181_17}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_out { MEM_WIDTH 8 MEM_SIZE 8 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ DATA_OUT int 8 regular {axi_master 1}  }
	{ output_logits int 64 regular  }
	{ local_out int 8 regular {array 8 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "DATA_OUT", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "output_logits","offset": { "type": "dynamic","port_name": "output_logits","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "local_out", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ local_out_address0 sc_out sc_lv 3 signal 2 } 
	{ local_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ local_out_q0 sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_out", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	local_out { ap_memory {  { local_out_address0 mem_address 1 3 }  { local_out_ce0 mem_ce 1 1 }  { local_out_q0 mem_dout 0 8 } } }
}
