...
#
# Script generated by Vivado on Tue Sep 22 22:21:38 +0530 2026
...
export RDI_DATADIR="D:/AMD/2026.1/Vivado/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_23 -L processing_system7_vip_v1_0_25 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_37 -L fifo_generator_v13_2_15 -L axi_data_fifo_v2_1_37 -L axi_crossbar_v2_1_39 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_lite_ipif_v3_1_0 -L interrupt_control_v3_2_0 -L axi_gpio_v2_0_38 -L axi_protocol_converter_v2_1_38 -L axi_clock_converter_v2_1_36 -L blk_mem_gen_v8_4_13 -L axi_dwidth_converter_v2_1_38 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/AMD/2026.1/Vivado/data/xsim"
  fi
