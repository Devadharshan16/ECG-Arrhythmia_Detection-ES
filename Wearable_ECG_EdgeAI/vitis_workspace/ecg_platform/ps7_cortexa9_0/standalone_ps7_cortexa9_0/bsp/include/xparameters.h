...
#define XPAR_XTINY_ECG_INFERENCE_NUM_INSTANCES 1

/* Definitions for peripheral TINY_ECG_INFERENCE_0 */
#define XPAR_TINY_ECG_INFERENCE_0_COMPATIBLE "xlnx,tiny-ecg-inference-1.0"
#define XPAR_TINY_ECG_INFERENCE_0_BASEADDR 0x40000000
#define XPAR_TINY_ECG_INFERENCE_0_HIGHADDR 0x4000ffff
#define XPAR_TINY_ECG_INFERENCE_0_BASEADDR_1 0x40010000

/* Canonical definitions for peripheral TINY_ECG_INFERENCE_0 */
#define XPAR_XTINY_ECG_INFERENCE_0_BASEADDR 0x40000000
#define XPAR_XTINY_ECG_INFERENCE_0_HIGHADDR 0x4000ffff
#define XPAR_XTINY_ECG_INFERENCE_0_COMPATIBLE "xlnx,tiny-ecg-inference-1.0"
